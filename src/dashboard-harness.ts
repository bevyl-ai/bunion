...
const items: BoardItem[] = [
  ...
  // blocked ticket — waiting on another Linear issue, distinct from a plain capacity-queued one
  {
    identifier: 'BEV-6501',
    title: 'Blocked ticket — waiting on BEV-5990 to finish',
    state: 'Backlog',
    priority: 2,
    host: null,
    prUrl: null,
    url: 'https://linear.app/bevyl/issue/BEV-6501',
    note: null,
    status: 'blocked',
    blockedBy: [{ identifier: 'BEV-5990', state: 'In Progress' }],
    enteredAt: now - 5 * 3600_000,
    endedAt: null,
    turn: 0,
    activity: '',
