// SUPERSEDED by dashboard.ts (feat/dashboard-frontend-rewrite): the client-side HTML-string/manual-DOM dashboard
// was replaced by a real Preact component tree under dashboard-client/, byte-verified against every behavior in
// this file before the swap. Kept here purely as a diffable reference during review — not imported anywhere,
// not part of the runtime. Safe to delete once the new dashboard has been operator-verified in production.
